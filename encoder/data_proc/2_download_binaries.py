...
if __name__ == '__main__':
    ...
    parser.add_argument('--pkg_list_path',type=str, default="/path/to/pkg_lists/multiarch_pkg_list_amd64_armel_i386.txt", help='')
    parser.add_argument('--output_dir',type=str, default="/path/to/global_trunk_4_cpus", help='Path to output folder.')
