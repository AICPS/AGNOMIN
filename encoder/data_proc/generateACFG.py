...
def init_ghidra_paths():
	try:
		ghidra_dir = r"/path/to/ghidra_10.0_PUBLIC_20210621"
		#ghidra_scripts = os.environ['GHIDRA_SCRIPTS']
		mindsight = r"/path/to/TreeEmbedding/data_proc"

		tmpGhidraProj = os.getcwd() + '/tmpProj'
		ghidra_project = r"/path/to/treeEmbed"
...
# bin_path = "/path/to/ALLSTAR/FetchFiles/test_amd64/libpangomm-1.4-dev_amd64/bin/"
