...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_dir',type=str, default="/path/to/global_trunk_4_cpus_2", help='')
    ...
    parser.add_argument('--ghidra_proj',type=str, default="~/ms", help='Path to ghidra project folder.')
