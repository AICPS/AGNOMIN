...
def copy_acfg_to_dest(root_dir, dest_dir):
    first_covered_folders = read_covered('/path/to/9000_bin_two_batches/first_batch_covered.txt')
    second_covered_folders = read_covered('/path/to/9000_bin_two_batches/second_batch_covered.txt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_dir',type=str, default="/path/to/9000_bin_two_batches", help='Path to acfg folders.')
    parser.add_argument('--dest_dir',type=str, default="/path/to/global_temp", help='Path to destination folders.')
